...
const PLACEHOLDER_GRADIENTS = [
  'linear-gradient(135deg, rgba(232,164,74,.35), rgba(58,44,72,.55))',
  'linear-gradient(135deg, rgba(91,155,213,.30), rgba(58,44,72,.55))',
  'linear-gradient(135deg, rgba(76,175,125,.28), rgba(58,44,72,.55))',
  'linear-gradient(135deg, rgba(216,138,154,.30), rgba(58,44,72,.55))',
];
